...
const InscricaoVoluntaria = () => {
  ...
  const validate = () => {
    ...
    if (!apresentacao.trim()) {
      newErrors.apresentacao = "Por favor, preencha este campo.";
      missing.push("Apresentação");
    }
    if (!habilidades.trim() && !curriculo) {
      newErrors.habilidades = "Por favor, preencha este campo ou envie um currículo.";
      newErrors.curriculo = "Por favor, envie um currículo ou preencha o campo acima.";
      missing.push("Experiências/habilidades ou Currículo");
    }
        ...
        <CardForm
          ...
          children1={
            <>
              <Textarea
                text="Apresentação"
                placeholder="Fale um pouco sobre você! Quem é você, o que te motiva, por que quer ser voluntário(a) no Mina Tech?"
                value={apresentacao}
          ...
          children2={
            <>
              <Textarea
                text="Experiências e habilidades relevantes"
                placeholder="Descreva experiências, conhecimentos ou habilidades que você acredita serem úteis para o projeto. Ex: educação, tecnologia, comunicação, gestão, design..."
                value={habilidades}
