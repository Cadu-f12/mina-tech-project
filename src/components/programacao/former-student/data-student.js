...
export const formerStudents = [
    ...
    },
    {
        ...
        image: exAluna2,
        title: "Maria Eduarda",
        text: "Participar do projeto entre 2020 e 2022 transformou minha visão de futuro e fortaleceu minha confiança na programação. Hoje, cursando Ciência da Computação, reconheço o quanto essa experiência contribuiu para minha base acadêmica e profissional. Sou grata por iniciativas como essa, que incentivam mais mulheres a conquistarem espaço e crescerem na tecnologia.",
        reverse: true,
    },
];
